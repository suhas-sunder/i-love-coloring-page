# Round 5D R2 CORS And Content-Type Update
...
- Verification command: `node pipeline/scripts/round-5d-verify-svg-webp-public-urls.mjs --public-base-url https://YOUR-ASSET-DOMAIN.com/coloring-pages`
