# Round 5E R2 CORS And Content-Type Update
...
- Verification command: `node pipeline/scripts/round-5e-verify-svg-webp-public-urls.mjs --public-base-url https://YOUR-ASSET-DOMAIN.com/coloring-pages`
