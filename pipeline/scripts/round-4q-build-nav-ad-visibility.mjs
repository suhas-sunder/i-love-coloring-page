...
function buildAdVisibilityResults({ source, screenshots }) {
  ...
  return {
    ...
    placeholderOffBuildCommand: "Historical disabled-placeholder build command removed.",
    placeholderOnBuildCommand: "$env:NEXT_PUBLIC_COLORING_ASSET_BASE_URL='http://127.0.0.1:4175/coloring-pages'; npm run dev",
    summary: {
      placeholdersVisibleWhenEnabled: onScreenshots > 0 || /Development placeholder/.test(source.adSlot),
